...
<a href="http://localhost/foodfinal/home1.php">Back</a>
</div>
...
<div class="container-fluid">
  <div class="row d-flex justify-content-center align-items-center m-0" style="height: 100vh;">
    <div class="login_oueter">
      ...
      <h4 align="center"> Admin Login</h4><hr>
        <div class="form-row" align="center">
          ...
          <div class="col-12">
            <div class="input-group mb-3">
              ...
              <input name="username" type="text"  class="input form-control" id="username" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required>
            </div>
          </div>
          <div class="col-12">
            <div class="input-group mb-3">
