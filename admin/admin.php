...
<body>
<button id="myButton" align="right" onclick="window.location.href='http://localhost/foodfinal/admin/'">Back</button>
<?php
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="reset" value="cancel" id="close-edit" class="option-btn" onclick="javascript:window.location='http://localhost/foodfinal/admin/admin.php';">   </form>
